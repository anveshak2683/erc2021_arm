...
echo_and_run cd "/projects/arm/src/ERC_2021_simulator/ur_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/projects/arm/src/ERC_2021_simulator/ur_driver/setup.py" \
     \
    build --build-base "/projects/arm/build/ERC_2021_simulator/ur_driver" \
    install \
    --root="${DESTDIR-/}" \
