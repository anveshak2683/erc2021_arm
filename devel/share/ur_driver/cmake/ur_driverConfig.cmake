...
if("TRUE" STREQUAL "TRUE")
  set(ur_driver_SOURCE_PREFIX /projects/arm/src/ERC_2021_simulator/ur_driver)
  set(ur_driver_DEVEL_PREFIX /projects/arm/devel)
  ...
  set(ur_driver_INSTALL_PREFIX /projects/arm/install)
...
if(NOT "/projects/arm/devel/include " STREQUAL " ")
  set(ur_driver_INCLUDE_DIRS "")
  set(_include_dirs "/projects/arm/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/projects/arm/src/ERC_2021_simulator/ur_driver/${idir}'.  ${_report}")
    endif()
